 ...
 * @author shannah
 */
public class MirahCompletionItem implements CompletionItem {
    ...
    public MirahCompletionItem(String text, int caretOffset) {
        this.text = text;
    ...
    public void render(Graphics g, Font font, Color color, Color color1, int width, int height, boolean selected) {
        CompletionUtilities.renderHtml(fieldIcon, text, null, g, font,
