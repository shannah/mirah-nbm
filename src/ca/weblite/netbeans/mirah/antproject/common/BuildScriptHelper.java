...
package ca.weblite.netbeans.mirah.antproject.common;
...
public class BuildScriptHelper {
    ...
    private static final String MIRAH_BUILD_XML = "nbproject/mirah-build.xml"; // NOI18N
    private static final String MIRAH_BUILD_65_XML = "ca/weblite/netbeans/mirah/antproject/resources/mirah-build-65.xml"; // NOI18N
    private static final String MIRAH_BUILD_SAMPLE_65_XML = "ca/weblite/netbeans/antproject/resources/mirah-build-sample-65.xml"; // NOI18N
        ...
        if (MirahExtender.isActive(project)) {
            ...
            try {
                ...
                if ((GeneratedFilesHelper.FLAG_MODIFIED & flags) != 0
                        ...
                        && (hasBuildScriptFrom65(project, MIRAH_BUILD_65_XML) || hasBuildScriptFrom65(project, MIRAH_BUILD_SAMPLE_65_XML))) {
                    FileObject buildScript = project.getProjectDirectory().getFileObject(MIRAH_BUILD_XML);
                    if (buildScript != null) {
                        buildScript.delete();

                        helper.generateBuildScriptFromStylesheet(MIRAH_BUILD_XML, stylesheet);
                        return;
                    }
                }

                helper.refreshBuildScript(MIRAH_BUILD_XML, stylesheet, checkProjectXml);
    ...
    private static boolean hasBuildScriptFrom65(Project project, String resource) throws IOException {
        FileObject fo = project.getProjectDirectory().getFileObject(MIRAH_BUILD_XML);
        if (fo == null) {
            return false;
        }
