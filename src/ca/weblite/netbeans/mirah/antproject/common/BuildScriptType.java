...
public enum BuildScriptType {
    ...
    J2SE {
        @Override
        protected String getMirahBuildXslPath() {
            return "ca/weblite/netbeans/mirah/antproject/resources/mirah-build-j2se.xsl"; // NOI18N
        }
    };

    public URL getStylesheet() {
        return this.getClass().getClassLoader().getResource(getMirahBuildXslPath());
    }

    protected abstract String getMirahBuildXslPath();
