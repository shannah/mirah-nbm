...
import ca.weblite.netbeans.mirah.antproject.base.AbstractMirahExtender;
...
/**
 * Implementation of the MirahExtender for Java EE Ant based projects.
 *
...
public class WebMirahExtender extends AbstractMirahExtender {

    public WebMirahExtender(Project project) {
        super(project);
    }

    @Override
    protected URL getMirahBuildXls() {
